...
class SubCategoryController extends Controller
{
    ...
    public function StoreSubCategory(Request $request){
        ...
        return redirect()->route('allsubcategory')->with('message', 'Sub Category has been added Successfully!');
    }
    ...
    public function DeleteSubCat($id){
        ...
        return redirect()->route('allsubcategory')->with('message', 'Sub Category has been Deleted Successfully!');
    }
