   ...
   <body>
               ...
               <div class="containt_main">
                  ...
                  <div class="dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                       ...
                       {{route('category', [$category->id, $category->slug])}}">{{$category->category_name}}</a>
                       @endforeach
                     </div>
                  </div>
                  <div class="main">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <div class="dropdown-menu ">
                           ...
                           <img src="{{asset('home/images/Rocky.png')}}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="location_main">Help Line  Number : <a href="#">09054100025</a></div>
         </div>
      </div>
      <!-- footer section end -->
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">Capstone Project by Scorpions</a></p>
         </div>
      </div>
